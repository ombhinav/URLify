...
const FormContainer: React.FunctionComponent<IFormContainerProps> = (props) => {
  ...
  return (
    <div className="container mx-auto p-2">
      <div className=" my-8 rounded-xl bg-[#D9B08C]">
        <div className="w-full h-full rounded-xl p-20 ">
          <h2 className=" text-4xl text-center pb-7 text-green-950 ">URLify: Shrink your links with a wink!</h2>
          
          <p className="text-green-950 text-center pb-8 text-sm font-thin">
